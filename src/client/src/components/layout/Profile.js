				...
				<div className="p-1 col-4">
					...
					<div className="story-part pt-2">
						...
						<p>
							...
							posuere ante ut pretium lobortis. Proin convallis dolor massa, nec
							congue metus imperdiet vitae. Pellentesque ut sagittis ante, nec
							auctor magna. Nulla facilisi. Praesent ut ante in dolor fringilla
							vehicula. Mauris finibus nec tellus eu tincidunt. Ut id tincidunt
							magna, quis ornare mi. Nunc eget aliquam augue, quis mattis
							libero. Maecenas et aliquam leo. Phasellus tincidunt arcu id
							molestie vulputate. Ut facilisis ligula sit amet tellus lobortis
							blandit. Pellentesque et augue a lorem aliquet lobortis.
							Pellentesque ipsum ex, auctor et dignissim nec, semper id tortor.
						</p>
					</div>
